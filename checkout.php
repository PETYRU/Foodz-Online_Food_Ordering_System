    ...
    <div class="site-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container m-t-30">
                <form action="order_razorpay.php" method="post">
                    <div class="widget clearfix">

                        <div class="widget-body">
                            <form method="post" action="order_razorpay.php">
                                <div class="row">
                                            ...
                                            <ul class=" list-unstyled">
                                                ...
                                                <li>
                                                    <label class="custom-control custom-radio  m-b-10">
                                                        <input name="mod" type="radio" value="paypal" class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">RazorPay <img src="images/razor.png" alt="" width="90"></span> </label>
                                                </li>
                                            </ul>
